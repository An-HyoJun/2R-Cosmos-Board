...
typedef struct _GC_VICTIM_LIST_ENTRY {
	...
	unsigned int fifo_head : 16;
	unsigned int fifo_tail : 16;
	unsigned int normal_threshold : 8;
	unsigned int cold_threshold : 8;
} GC_VICTIM_LIST_ENTRY, *P_GC_VICTIM_LIST_ENTRY;

typedef struct _GC_VICTIM_MAP {
	GC_VICTIM_LIST_ENTRY gcVictimList[USER_DIES];
